...
from train import train_random_forest, compute_metrics, XGBOOST_AVAILABLE, PYTORCH_AVAILABLE
...
class TestRandomForest:
    ...
    def test_train_random_forest(self, sample_data):
        ...
        model, metrics = train_random_forest(X_train, y_train, X_test, y_test, random_state=42)
    ...
    def test_deterministic_training(self, sample_data):
        ...
        model1, metrics1 = train_random_forest(X_train, y_train, X_test, y_test, random_state=42)

        model2, metrics2 = train_random_forest(X_train, y_train, X_test, y_test, random_state=42)
...
class TestXGBoost:
    ...
    def test_train_xgboost(self, sample_data):
        ...
        model, metrics = train_xgboost(X_train, y_train, X_test, y_test, random_state=42)
...
class TestNeuralNetwork:
    ...
    def test_train_nn(self, sample_data):
        ...
        model, metrics = train_neural_network(
            X_train, y_train, X_test, y_test, random_state=42, epochs=5, batch_size=32  # Quick test
        )
