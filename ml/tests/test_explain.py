...
class TestExplainPrediction:
    ...
    def test_basic_explanation(self, trained_model, sample_data):
        ...
        explanation = explain_prediction(trained_model, X_sample, feature_names, top_k=3)
    ...
    def test_without_feature_names(self, trained_model, sample_data):
        ...
        explanation = explain_prediction(trained_model, X_sample, feature_names=None, top_k=3)
    ...
    def test_1d_sample_input(self, trained_model, sample_data):
        ...
        explanation = explain_prediction(trained_model, X_1d, feature_names, top_k=3)
    ...
    def test_different_top_k_values(self, trained_model, sample_data):
        ...
        for k in [1, 3, 5]:
            explanation = explain_prediction(trained_model, X_sample, feature_names, top_k=k)
    ...
    def test_feature_importance_method(self, trained_model, sample_data):
        ...
        explanation = explain_prediction(
            trained_model, X_sample, feature_names, method="importance", top_k=3
        )
    ...
    def test_shap_method(self, trained_model, sample_data):
        ...
        explanation = explain_prediction(
            trained_model, X_sample, feature_names, method="shap", top_k=3
        )
...
class TestExplainBatchPredictions:
    ...
    def test_batch_explanation(self, trained_model):
        ...
        explanations = explain_batch_predictions(trained_model, X_batch, feature_names, top_k=3)
    ...
    def test_single_sample_batch(self, trained_model, sample_data):
        ...
        explanations = explain_batch_predictions(trained_model, X_sample, feature_names, top_k=2)
...
class TestGlobalFeatureImportance:
    ...
    def test_global_importance(self, trained_model):
        ...
        result = get_global_feature_importance(trained_model, feature_names, top_k=5)
    ...
    def test_global_importance_without_names(self, trained_model):
        ...
        result = get_global_feature_importance(trained_model, feature_names=None, top_k=3)
    ...
    def test_top_k_limit(self, trained_model):
        ...
        result = get_global_feature_importance(trained_model, feature_names, top_k=3)
...
class TestEdgeCases:
    ...
    def test_mismatched_feature_names(self, trained_model, sample_data):
        ...
        explanation = explain_prediction(trained_model, X_sample, wrong_names, top_k=3)
