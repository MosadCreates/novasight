...
class TestPredictionRequest:
    ...
    def test_valid_request(self):
        ...
        request = PredictionRequest(features={"orbital_period": 3.5, "transit_depth": 0.02})
    ...
    def test_non_numeric_features(self):
        ...
        with pytest.raises(ValidationError):
            PredictionRequest(features={"orbital_period": "not a number"})
    ...
    def test_valid_response(self):
        ...
        response = PredictionResponse(
            ...
            explain=PredictionExplanation(
                top_features=[FeatureImportance(name="orbital_period", value=0.8)]
            ),
        )
